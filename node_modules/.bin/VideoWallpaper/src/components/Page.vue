<template>
    <nav aria-label="Page navigation" v-if="this.total > 0">
        <ul class="pagination">
            <li @click="activePage = 1" title="First">
                <a href="#" aria-label="first">
                    <span aria-hidden="true">&laquo;</span>
                </a>
            </li>
            <li v-if="this.activePage > 1" @click="activePage --" title="Previous">
                <a href="#" aria-label="Previous">
                    <span aria-hidden="true">&larr;</span>
                </a>
            </li>
            <li v-for="(value, key) in pageList" :class="{active: value.active}" @click="activePage = value.text"><a href="#">{{value.text}}</a></li>
            <li v-if="this.activePage < this.total" @click="activePage ++" title="Next">
                <a href="#" aria-label="Next">
                    <span aria-hidden="true">&rarr;</span>
                </a>
            </li>
            <li @click="activePage = total" title="Last">
