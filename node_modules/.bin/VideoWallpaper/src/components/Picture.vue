    ...
    <div class="main">
        <div>
            <div class="col-xs-6 col-md-2 thumbnail imgDiv" v-for="(value, key) in pictureList" >
                <img class="imgStyle" :src="value.urlThumb" alt="..." height="150" @click="imgPop(value)">
            </div>
        </div>
        <page class='page' :total='total' :pageNum='activePage' @changePage='changePage'></page>
        <pop :popShow='popShow' :popPictureData='popPictureData' @popReturn='popReturn'></pop>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        imgPop: function(data) {
            this.popShow = true;
            this.popPictureData = data;
        },
        popReturn: function(data){
            this.popShow = data.show;
        }
    },
    mounted: function(){
        this.getPageData({pageNum: this.activePage, pageSize: this.pageSize})
